...
echo
echo "Setting Up Hyperledger Reliance Fabric Network (Asset Tracking System)"
echo
CHANNEL_NAME="$1"
DELAY="$2"
LANGUAGE="$3"
...
COUNTER=1
MAX_RETRY=15
ORGS="infrastructure power communication entertainment capital"
...
echo "Updating anchor peers for Communication..."
updateAnchorPeers 0 'communication'
cho "Updating anchor peers for Entertainment..."
updateAnchorPeers 0 'entertainment'
echo "Updating anchor peers for Capital..."
updateAnchorPeers 0 'capital'

echo
echo "========= All GOOD, Hyperledger Fabric Reliance Network (Asset Tracking System) Is Now Up and Running! =========== "
echo
